...
class S3ProxyConfigurator implements ConfiguratorContract
{
    ...
    protected array $config = [
        ...
        'SERVER_ENV_SOURCE' => [
            'file', 'envSource', 'The environments variables source, possible values: --file, --file=$filepath, vault',
        ],
        'S3_CACHE_DIR' => [
            '/tmp/s3-proxy', 'cacheDir', 'The directory to store the cache',
        ],
        ...
        'ENV_VAULT_PREFIX' => ["", 'vault_prefix', 'Vault Hashicorp. key prefix. Path to environments on kv storage'],
