    ...
    protected array $config = [
        ...
        'SERVER_WATCH_TARGET'     => [
            [
                ...
                'composer.lock',
                '.env',
            ], 'watchTargets', "The array of path for change detection.",
        ],
        'SERVER_LOG_LEVEL'        => [
            "NOTICE", 'logLevel',
        ...
        'SERVER_MAX_FORKS'         => [
            5, 'maxForks', 'Maximum number of forks allowed per worker. Limit of concurrent processes calculated by OPTION_WORKERS * (SERVER_MAX_FORKS + 1)',
        ],
        'SERVER_MODE'             => ['single', 'mode', 'Environment resolver mode: single, multi-tenant'],
        'SERVER_WARM_UP'          => [
            '/healthcheck', 'warmUp', 'Endpoint which will be triggered to warm up Laravel application on Single mode',
        ],
        'SERVER_TENANT_KEY'       => [
        ...
        'ENV_TENANT_ID'           => [
            '', 'tenant_id', 'Context of execution the command.',
        ],
        ...
        'ENV_VAULT_PREFIX'        => [
            "", 'vault_prefix', 'Vault Hashicorp. key prefix. Path to environments on kv storage',
        ],
        ...
        'ENV_DIR'                 => [
            './.envs', 'envs_dir', "The directory with .env files. Required if ENV_SOURCE is 'dir'",
        ],
        'ENV_FILE_UPDATE'         => [
            false,
            'env_file_update',
        ...
        'OPTION_USER'                  => [
            'www', 'user', 'Set the operating system user of the worker and task worker child processes.',
        ],
        'OPTION_GROUP'                 => [
            'www', 'group', 'Set the operating system user of the worker and task worker child processes.',
        ],
        'OPTION_STATIC_FILES_ENABLED'  => [false, 'enable_static_handler', 'Enable the WATCH mode for development.'],
        'OPTION_DOCUMENT_ROOT'         => [
            '/var/www/public', 'document_root', 'The base path on the project for static files locations.',
        ],
